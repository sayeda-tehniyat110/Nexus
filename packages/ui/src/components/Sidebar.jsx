...
export default function Sidebar({ open, onToggle }) {
    ...
    if (!open)
        return null;
    return (<div className="w-64 border-r border-border flex flex-col bg-card">
      <div className="p-3">
      ...
      <div className="flex-1 overflow-y-auto px-2">
        <div className="space-y-1">
          {conversations.map(conv => (<button key={conv.id} className="w-full flex items-center gap-2 px-3 py-2 rounded-md hover:bg-accent transition-colors text-left">
